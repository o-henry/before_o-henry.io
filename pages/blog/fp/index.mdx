...
In math, a function always takes input(s), and always gives an output. That means you should be using functions as mums as possible, and trying to avoid procedures wherever possible.
